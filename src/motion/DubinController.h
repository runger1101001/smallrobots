...
namespace SmallRobots {
    ...
    class DubinController {
        ...
        public:
            ...
            DubinController(DifferentialKinematics& drive);
            ~DubinController();
            ...
            void setRobotVelocityAndActivate(float _vRobot = DEFAULT_ROBOT_SPEED); //in mm/s and send move command with current radius
